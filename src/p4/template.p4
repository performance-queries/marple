...
struct ingress_metadata_t {
    bit<32> nhop_ipv4;
    /* perfq: rest of ingress_metadata_t to be filled! */
}
...
/* perfq: add necessary headers persistent _across_ switches */
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    /* perfq: add necessary tables */
    apply {
        /* perfq: add query pipeline! */
        set_nhop();
    }
}
